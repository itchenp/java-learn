...
import com.ithub.source.learn.spring.entity.Order;
import com.ithub.source.learn.spring.entity.Packaged;
...
public class SpringRabbitMQApplicationTests {
	...
	public void testSendJavaMessage() throws Exception {
		...
		//这里注意一定要修改contentType为 application/json
		messageProperties.setContentType("application/json");
		messageProperties.getHeaders().put("__TypeId__", "com.ithub.source.learn.spring.com.ithub.source.learn.spring.entity.Order");
		Message message = new Message(json.getBytes(), messageProperties);
